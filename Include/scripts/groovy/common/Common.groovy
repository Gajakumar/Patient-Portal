...
class Common {
	...
	def load_calculator_page() {
		WebUI.callTestCase(findTestCase("Test Cases/common/Katalon_Default_TCs/The Calculator page is loaded successfully"), [:], FailureHandling.STOP_ON_FAILURE)
	}

	@Then("I get the result (.*)")
	def check_result(String result) {
		WebUI.callTestCase(findTestCase('Test Cases/common/Katalon_Default_TCs/Check result'), [ ('result') : result ], FailureHandling.STOP_ON_FAILURE)
	}
