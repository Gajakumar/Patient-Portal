...
WebUI.verifyElementText(
	findTestObject('Provider Portal/Page_MaximEyes/Indication Msg below subject Fwd msg'),
...
WebUI.verifyElementText(
	findTestObject('Provider Portal/Page_MaximEyes/Indication Msg below Message field Fwd Msg'),
	'0 characters remaining'
)
