...
WebUI.setText(findTestObject('Authorized Individual/Page_Patient Portal/input_Legal First Name'), GlobalVariable.fname)

//Enter valid last name
WebUI.setText(findTestObject('Authorized Individual/Page_Patient Portal/input_Last Name'), GlobalVariable.lname)
...
WebUI.assertElementText(TO_patientName, GlobalVariable.fname+" "+GlobalVariable.lname, timeOut)
...
WebUI.assertElementText(TO_grantAccessTitle, 'Do you want to grant access to '+GlobalVariable.fname+" "+GlobalVariable.lname+'?', timeOut)
...
WebUI.assertElementText(TO_accessGrantedDesc, GlobalVariable.fname+" "+GlobalVariable.lname+' can now access your records!', timeOut)

String name = GlobalVariable.fname +" "+ GlobalVariable.lname
