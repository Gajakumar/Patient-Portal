...
//Verify toast msg
CustomKeywords.'common.ToastHelper.verifyMaximeyesToastMessage'('This encounter is now signed off.')
...
//Uncheck the Do nothing check box
