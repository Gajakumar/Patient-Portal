...
WebUI.setText(findTestObject('Object Repository/Page_MaximEyes/input_Name_AddNew_Patient_FirstName (2)'), 'Test')

WebUI.setText(findTestObject('Object Repository/Page_MaximEyes/input_Name_AddNew_Patient_LastName (2)'), 'Demo')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_MaximEyes/select_Primary_PhoneTypeID (1)'), '2', true)
...
WebUI.setText(findTestObject('Page_MaximEyes/input_DOB_DOBB'), '12/12/1997')
