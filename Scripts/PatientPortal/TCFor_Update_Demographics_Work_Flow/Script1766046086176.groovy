...
WebUI.callTestCase(findTestCase('Test Cases/common/Patient_Portal_Common/User Login With Username and Password'), [('Username') : UserNamePt
        , ('Password') : GlobalVariable.RestUpdatedPass], FailureHandling.STOP_ON_FAILURE)
...
// Wait until the setting button is clickable (visible and enabled)
...
//Verify fields on Update demographics page
...
CustomKeywords.'color.VerifyBagroundColor.verifyBagroundColor'(findTestObject('Object Repository/Page_Patient Portal/Primary Address checkbox'), 
    'background-color', 'rgb(126, 46, 239)')
...
// Expected blue (example: rgb(126, 46, 239))
CustomKeywords.'color.VerifyBagroundColor.verifyBagroundColor'(findTestObject('Object Repository/Page_Patient Portal/Primay Phone Email checkbox'), 
    'background-color', 'rgb(126, 46, 239)')
...
// 3️ FALL DOWN – TITLE
// ----------------------------------------------------
TestObject titleDropdown = findTestObject('Object Repository/Page_Patient Portal/select_Name_title-select')
...
// 4️ FALL DOWN – SUFFIX
// ----------------------------------------------------
TestObject suffixDropdown = findTestObject('Object Repository/Page_Patient Portal/select_Name_suffix-select')
...
// ----------------------------------------------------
TestObject phoneTypeDropdown = findTestObject('Object Repository/Page_Patient Portal/select_Action_phone-type-0')
...
// ----------------------------------------------------
TestObject countryDropdown = findTestObject('Object Repository/Page_Patient Portal/select_Primary_country-0')
...
//Select Phone type
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Patient Portal/select_Action_phone-type-0'), 'Select', 
    false)
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Patient Portal/p_Primary Email_text-red-500 text-xs mt-1'), 
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Patient Portal/select_Action_phone-type-0'), 'Mobile', 
    true)
...
CustomKeywords.'common.ToastHelper.verifyToastMessage'('Phone number deleted successfully!')

//Click on + button to add address
