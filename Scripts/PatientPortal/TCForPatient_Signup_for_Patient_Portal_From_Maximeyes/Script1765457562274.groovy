...
//WebUI.verifyElementNotClickable(findTestObject('Scenario Update1703/Page_MaximEyes/span_Send Sign Up Email to'))

//// Long combined text (use contains instead of exact match)
//String combinedText = normalize(
//	WebUI.getText(findTestObject('Scenario Update1703/Page_MaximEyes/span_Send Sign Up Email to_1'))
//)
//
//
//WebUI.verifyMatch(combinedText.contains("Send Sign Up Email to"), true, false)
