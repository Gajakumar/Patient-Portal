...
WebUI.click(findTestObject('Object Repository/Page_MaximEyes/Electronic Files'))

WebUI.waitForElementNotVisible(findTestObject('Page_MaximEyes/Busy Indicator'), 30)

WebUI.delay(10)

WebUI.sendKeys(findTestObject('Object Repository/Page_MaximEyes/BrowsePDF'), 'C:\\Users\\Gajakumar_a\\Pictures\\Enc Summary.pdf')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_MaximEyes/Category'), 'Amsler Grid', true)

WebUI.waitForElementNotVisible(findTestObject('Page_MaximEyes/Busy Indicator'), 30)

WebUI.delay(10)

WebUI.click(findTestObject('Object Repository/Page_MaximEyes/SaveBtn'))
